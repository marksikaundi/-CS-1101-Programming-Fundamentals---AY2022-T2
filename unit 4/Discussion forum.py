#1) ("Debugging") lists three possibilities to consider if a function is not working.
    # First, something wrong with the arguments the function is getting, a precondition is violated.
...
#2) Define "precondition" and "postcondition" as part of your description. 
    ...
    #The "precondition" states the situation under which the function operates correctly.
    #The "postcondition" states what the function has accomplished when it terminates.
